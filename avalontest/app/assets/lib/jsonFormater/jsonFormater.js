...
var tmpPath = window.getCurrAbsPath();
var scriptCurrAbsdirectory = tmpPath.substring(0,tmpPath.lastIndexOf('/'))
...
function JsonFormater(opt) {
    this.options = $.extend({
        ...
        singleTab: "  ",
        quoteKeys: true,
        imgCollapsed:scriptCurrAbsdirectory+ "/images/Collapsed.gif",
        imgExpanded: scriptCurrAbsdirectory+"/images/Expanded.gif",
        isCollapsible: true
    }, opt || {});
